...
const CONTRACT_HASH = 'f8c969bfa7553a23deab0f77fb43210d4810156a977e0cc2695b23182e5b41d0';
...
const args = sdk.Args.fromMap({
  qvac_peer_id: sdk.CLValue.newCLString('real-stake-peer-2'),
  name: sdk.CLValue.newCLString('Real Stake Provider 2'),
  task_types: sdk.CLValue.newCLUInt32(1),
