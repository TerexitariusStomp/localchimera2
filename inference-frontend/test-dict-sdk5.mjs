...
async function main() {
  ...
  const dictId = sdk.ParamDictionaryIdentifierURef.fromURef(
    sdk.URef.fromString('uref-b06584e6b0ad3bf7866374024eb9b5513a9f1bf83f90e410a4bf599cd7aea437-007'),
    'list'
  );
  
  const res = await client.getDictionaryItemByIdentifier(stateRootHash.stateRootHash, dictId);
