...
const args = sdk.Args.fromMap({
  ...
  escrow_vault: sdk.CLValue.newCLByteArray(key.publicKey.accountHash().hashBytes),
});

const wasmBytes = new Uint8Array(readFileSync('/home/user/CascadeProjects/chimera-fortytwo-node/contracts-casper/target/wasm32v1-none/release/reputation.wasm'));
