 ...
 *
 * This allows SDK providers (BTT AI Miner, Golem, Anyone Protocol,
 * Mysterium, Earnidle, Casper) to appear in the desktop app alongside
 * native QVAC miners (Chutes, Routstr, Casper, etc.).
 */
